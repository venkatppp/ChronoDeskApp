      ...
      {options.map((option) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex shrink-0 items-center gap-1.5 rounded-[calc(var(--radius-control)-3px)] px-3 py-1 text-[13px] font-medium transition-all duration-100 ease-out motion-safe:active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--color-accent)/60",
              isActive
