  ...
  return (
    <section className="bg-surface-hover border border-border rounded-3xl overflow-hidden">
      ...
      <div className="p-8 space-y-6">
        ...
        {/* Provider Selection */}
        <div>
          <label className="block text-sm font-bold text-foreground mb-3">Provider</label>
        ...
        {/* Base URL */}
        <div>
          <label htmlFor="base_url" className="block text-sm font-bold text-foreground mb-2">
            Base URL
          </label>
          <input
            id="base_url"
            ...
            className="w-full px-4 py-3 bg-background-tertiary border border-border rounded-xl text-foreground placeholder-muted-foreground focus:outline-none focus:border-accent transition-colors"
          />
        ...
        {/* API Key */}
        <div>
          <label htmlFor="api_key" className="block text-sm font-bold text-foreground mb-2">
            API Key
          </label>
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pr-12 bg-background-tertiary border border-border rounded-xl text-foreground placeholder-muted-foreground focus:outline-none focus:border-accent transition-colors font-mono text-sm"
            />
            <button
              type="button"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="temperature" className="block text-sm font-bold text-foreground mb-2">
              Temperature
            </label>
            <input
              id="temperature"
              ...
              className="w-full px-4 py-3 bg-background-tertiary border border-border rounded-xl text-foreground focus:outline-none focus:border-accent transition-colors"
            />
            <p className="text-xs text-muted-foreground mt-2">0.0 = deterministic, 2.0 = creative</p>
          </div>

          <div>
            <label htmlFor="max_tokens" className="block text-sm font-bold text-foreground mb-2">
              Max Tokens
            </label>
            <input
              id="max_tokens"
              ...
              className="w-full px-4 py-3 bg-background-tertiary border border-border rounded-xl text-foreground focus:outline-none focus:border-accent transition-colors"
            />
            <p className="text-xs text-muted-foreground mt-2">Maximum response length</p>
          </div>
        </div>

        <div>
          <label htmlFor="context_window" className="block text-sm font-bold text-foreground mb-2">
            Context Window
          </label>
          <input
            id="context_window"
        ...
        <div className="flex items-center gap-3 pt-4">
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-accent text-accent-foreground rounded-xl font-bold text-sm hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
          >
            {isSaving ? (
              <>
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-background-tertiary text-foreground border border-border rounded-xl font-bold text-sm hover:bg-surface-hover transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isTesting ? (
              <>
                <Loader2 className="h-4 w-4 animate-spin" />
